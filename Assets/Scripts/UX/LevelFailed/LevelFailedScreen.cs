    ...
    public class LevelFailedScreen : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            if (CoopGameManager.Instance != null)
                CoopGameManager.Instance.OnLevelFailed += HandleLevelFailed;
        }
        ...
        {
            SetLineText(MenuOption.Retry, "Retry Level");
            SetLineText(MenuOption.Quit, "Return to Menu");
        }
